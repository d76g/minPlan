    ...
    <section id="home">
        <div class="container flex flex-col content-start  w-auto h-screen bg-gray-100 items-center justify-center">
            <div class="flex sm:mt-1 flex-col items-center justify-center">
                ...
                <h1 class="text-lg sm:text-4xl "><span class="mainColor">MinPlan</span></h1>
                ...
                <p class="text-sm text-center font-bold sm:text-base pb-4">Fill the form to get the app </br>customed for you.</p>
            </div>
