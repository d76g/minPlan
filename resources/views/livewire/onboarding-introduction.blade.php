...
<div class="flex flex-col w-full h-screen sm:text-lg overflow-hidden sm:text-md" wire:poll.750ms>
    ...
    <div class="relative w-60 sm:w-72 mx-auto h-80 flex flex-col justify-center items-center mt-20">
                ...
                <div class="flex px-2 gap-2 mb-2 content-center justify-center text-base">
                    <div class="flex flex-col py-2 content-center justify-center ">
                        <p class="my-2 text-center w-[240px] h-[33px]">
                            {{GoogleTranslate::trans('We are here for you in times of crisis.',session()->get('locale') ?? app()->getLocale())}}</p>
                    </div>
            ...
            <div class="w-auto {{$currentStep == 2 ? 'block' : 'hidden'}}" id="step-2">
                <div class="flex px-2 gap-2 mb-2 content-center justify-center text-base">
                    <div class="flex flex-col py-2 content-center justify-center ">
                        <p class="my-2 text-center w-[240px] h-[33px]">
                            {{GoogleTranslate::trans('We will help you and your loved ones cope with this',session()->get('locale') ?? app()->getLocale())}}</p>
                ...
                <div class="flex px-2 gap-2 mb-2 content-center justify-center text-sm">
                    <div class="flex flex-col py-2 content-center justify-center ">
                        <p class="my-2 text-center w-60">
                            {{GoogleTranslate::trans('To provide the best Information we need to know which country you are in:',session()->get('locale') ?? app()->getLocale())}}</p>
                        <div class="flex flex-col justify-center items-center pt-4">
                            
                            <label for="country" class="pb-2">{{GoogleTranslate::trans('Choose your country',session()->get('locale') ?? app()->getLocale())}}</label>
                            <select wire:model.prevent="country" id="country" class="box-bg py-2 px-4 my-1 rounded-full cursor-pointer text-sm block focus:ring-blue-500 focus:border-blue-500" name="country">
                                <option selected>{{GoogleTranslate::trans('Select Country',session()->get('locale') ?? app()->getLocale())}}</option>
            ...
            <div class="w-auto {{$currentStep == 4 ? 'block' : 'hidden'}}" id="step-3">
                <div class="flex px-2 gap-2 mb-2 content-center justify-center text-sm flex-col">
                    <div class="w-auto mt-4 flex justify-center flex-col items-center">
                        ...
                        <p class="mb-2 text-center text-base w-60 h-11">{{GoogleTranslate::trans('Press the shield icon, if you are in an acute mental crisis.',session()->get('locale') ?? app()->getLocale())}}</p>
                    </div>
                    <div class="w-auto mt-4 flex justify-center flex-col items-center">
                        <a href="/home/guidance"><img src="{{URL::asset('/images/outline_health_and_safety.svg')}}" alt="Guidance Icon"></a>
                        <p class="mb-2 text-center text-base w-60 h-11">{{GoogleTranslate::trans('Press the guidance icon, if you need support',session()->get('locale') ?? app()->getLocale())}}</p>
                    </div>
