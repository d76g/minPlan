<div class="flex flex-col w-full h-screen sm:text-lg overflow-hidden sm:text-md ">
    <div class="flex justify-end w-full h-auto">
        ...
        <div class="hidden" id="langMenu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
            <select name="lang" id="langs" class="rounded-lg py-2 border-slate-500 text-sm mr-2 mt-2 changeLang"
    ...
    <div class="w-64 sm:w-72 pt-6 mx-auto">
            ...
            {{-- End --}}
                ...
                {{-- Step 2 --}}
                <div class="w-auto {{$currentStep == 5 ? 'block' : 'hidden'}}" id="step-5">   
                    <div class="flex px-2 gap-2 mb-2 content-center justify-center text-sm">
                        <div class="flex flex-col py-2 content-center justify-center">
                                <p class="my-2 text-center">What is your age ?</p>
                            <a href="/underagehelp" class="border-[1px] border-gray-600 py-2 px-2 my-1 rounded-full text-center  cursor-pointer"><label for="age">
                                15 - 30
                            </label></a>
        ...
        @endif
            ...
            {{-- Buttons --}}
            <div class="relative h-14 flex justify-center content-center w-full px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse sm:mt-10">
