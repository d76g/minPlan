...
<div class="flex justify-between w-full">
    <div class="flex items-center mainColor bg-white mt-4 ml-3 rounded-md py-2 px-3 hover:text-black transition ease-in-out hover:-translate-y-1 cursor-pointer">
    ...
    <div class="flex justify-end mr-3">
        <div x-data="{ showDropdown: false}" class="flex flex-row-reverse" id="langMenu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
            <button @click="showDropdown = ! showDropdown " class="mt-4 mr-4">
                <span class="material-icons-outlined mainColor hover:text-black bg-white p-1 rounded-md">translate</span>
            </button>
