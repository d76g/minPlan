<x-app-layouts>
    <div class="relative h-auto sm:h-screen flex flex-col bg-gray-50 w-auto sm:w-screen">
        ...
        <div class="bg-white w-64 sm:w-[700px] sm:h-[350px] h-[400px] mt-6 sm:mt-0 absolute left-16 top-64 sm:top-80 sm:left-96 rounded-xl drop-shadow-lg grid grid-cols-1 sm:grid-cols-3 justify-center place-items-center">
        ...
        <div class="absolute w-12 h-12 rounded-full bg-gradient-to-r from-gray-200 to-red-400 sm:top-[26rem] sm:left-[22rem] top-72 left-8"></div>
